...
Comprehensive tests for `.agent/statusline.cjs` and supporting libraries.
...
node .agent/hooks/lib/__tests__/statusline-suite.cjs
```

Run individual suites when debugging:

```bash
node .agent/hooks/lib/__tests__/usage-limits-cache.test.cjs
node .agent/hooks/lib/__tests__/statusline.test.cjs
node .agent/hooks/lib/__tests__/statusline-integration.test.cjs
node .agent/hooks/lib/__tests__/statusline-scenarios.test.cjs
```
...
- `/.agent/statusline.cjs`
- `/.agent/hooks/lib/colors.cjs`
- `/.agent/hooks/lib/transcript-parser.cjs`
- `/.agent/hooks/lib/config-counter.cjs`
- `/.agent/hooks/lib/git-info-cache.cjs`
