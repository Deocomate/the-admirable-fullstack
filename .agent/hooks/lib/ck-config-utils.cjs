...
const LOCAL_CONFIG_PATH = '.agent/.ck.json';
const GLOBAL_CONFIG_PATH = path.join(os.homedir(), '.agent', '.ck.json');
 ...
 *   2. Global config (~/.agent/.ck.json) - user preferences
 *   3. Local config (./.agent/.ck.json) - project-specific overrides
 *
