...
**Option B: `.agent/.env`** (project-level override):
```bash
DISCORD_WEBHOOK_URL=https://discord.com/api/webhooks/YOUR_WEBHOOK_ID/YOUR_WEBHOOK_TOKEN
```

**Option C: `.agent/hooks/.env`** (hook-specific):
```bash
DISCORD_WEBHOOK_URL=https://discord.com/api/webhooks/YOUR_WEBHOOK_ID/YOUR_WEBHOOK_TOKEN
```
...
**Implementation:** `.agent/hooks/notifications/notify.cjs` + `providers/discord.cjs`
...
**Claude Code Documentation:** https://docs.agent.com/claude-code
