...
test('formatConfigPath with claudeDir', formatConfigPath('/home/user/.agent').includes('.ckignore'));
test('formatConfigPath prefers explicit configPath', formatConfigPath('/home/user/.agent', '/tmp/project/.ckignore') === '/tmp/project/.ckignore');
test('formatConfigPath without claudeDir', formatConfigPath(null) === '.agent/.ckignore');
test('formatConfigPath empty string', formatConfigPath('') === '.agent/.ckignore');
...
const blockError = formatBlockedError({
  ...
  tool: 'Bash',
  claudeDir: '/home/user/project/.agent',
