...
class Messages(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        [user guide](https://docs.agent.com/en/docs/initial-setup)
        ...
        Args:
          max_tokens: The maximum number of tokens to generate before stopping.
              ...
              [models](https://docs.agent.com/en/docs/models-overview) for details.
          ...
          messages: Input messages.
              ...
              See [input examples](https://docs.agent.com/en/api/messages-examples).

              Note that if you want to include a
              [system prompt](https://docs.agent.com/en/docs/system-prompts), you can use the
          ...
          output_format: Deprecated: Use `output_config.format` instead. See
              [structured outputs](https://platform.agent.com/docs/en/build-with-claude/structured-outputs)
          ...
          service_tier: Determines whether to use priority capacity (if available) or standard capacity
              ...
              [service-tiers](https://docs.agent.com/en/api/service-tiers) for details.
          ...
          stream: Whether to incrementally stream the response using server-sent events.
              ...
              See [streaming](https://docs.agent.com/en/api/messages-streaming) for details.

          system: System prompt.

              A system prompt is a way of providing context and instructions to Claude, such
              as specifying a particular goal or role. See our
              [guide to system prompts](https://docs.agent.com/en/docs/system-prompts).
          ...
          thinking: Configuration for enabling Claude's extended thinking.
              ...
              See
              [extended thinking](https://docs.agent.com/en/docs/build-with-claude/extended-thinking)
              for details.
          ...
          tools: Definitions of tools that the model may use.
              ...
              [server tools](https://docs.agent.com/en/docs/agents-and-tools/tool-use/overview#server-tools),
              see their individual documentation as each has its own behavior (e.g., the
              [web search tool](https://docs.agent.com/en/docs/agents-and-tools/tool-use/web-search-tool)).
              ...
              See our [guide](https://docs.agent.com/en/docs/tool-use) for more details.
    ...
    def create(
        ...
        *,
        ...
        if model in MODELS_TO_WARN_WITH_THINKING_ENABLED and thinking and thinking["type"] == "enabled":
            warnings.warn(
                f"Using Claude with {model} and 'thinking.type=enabled' is deprecated. Use 'thinking.type=adaptive' instead which results in better model performance in our testing: https://platform.agent.com/docs/en/build-with-claude/adaptive-thinking",
                UserWarning,
                stacklevel=3,
            )
    ...
    def count_tokens(
        ...
        *,
        ...
        [user guide](https://docs.agent.com/en/docs/build-with-claude/token-counting)
