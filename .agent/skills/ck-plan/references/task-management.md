...
Claude Tasks are **ephemeral** — they die when the session ends. `~/.agent/tasks/` holds lock files only, NOT task data. Plan files (plan.md, phase-XX.md with checkboxes) are the **persistent** layer.
