...
1. Scan the codebase and calculate the number of files with LOC in each directory (skip `.agent`, `.opencode`, `.git`, `tests`, `node_modules`, `__pycache__`, `secrets`, etc.)
...
1. Run: `node .agent/scripts/validate-docs.cjs docs/`
