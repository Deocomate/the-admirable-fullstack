...
New skills **MUST** be created in CWD: `./.agent/skills/` (**NOT** `~/.agent/skills/` unless requested)
...
- [Agent Skills Docs](https://docs.agent.com/en/docs/claude-code/skills.md)
- [Best Practices](https://docs.agent.com/en/docs/agents-and-tools/agent-skills/best-practices.md)
