...
1. **Create plugins** — commands, agents, hooks, MCP servers, LSP servers (see [Plugins docs](https://code.agent.com/docs/en/plugins.md))
2. **Create marketplace file** — `.agent-plugin/marketplace.json` listing plugins + sources
...
```bash
# 1. Create structure
mkdir -p my-marketplace/.agent-plugin
mkdir -p my-marketplace/plugins/review-plugin/.agent-plugin
...
- [Plugin Marketplaces](https://code.agent.com/docs/en/plugin-marketplaces.md)
- [Discover Plugins](https://code.agent.com/docs/en/discover-plugins.md)
- [Create Plugins](https://code.agent.com/docs/en/plugins.md)
- [Plugins Reference](https://code.agent.com/docs/en/plugins-reference.md)
- [Plugin Settings](https://code.agent.com/docs/en/settings.md#plugin-settings)
