...
- `.agent-plugin/marketplace.json` exists at specified path?
...
| Error | Cause | Fix |
|-------|-------|-----|
| `File not found: .agent-plugin/marketplace.json` | Missing manifest | Create with required fields |
...
- See [Plugin caching docs](https://code.agent.com/docs/en/plugins-reference.md#plugin-caching-and-file-resolution)
