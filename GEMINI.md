...
**IMPORTANT:** DO NOT modify skills in `~/.agent/skills` directory directly. **MUST** modify skills in this current working directory. Unless you are asked to do so.
...
**DO NOT** use `chore` and `docs` in commit messages of file changes in `.agent` directory.
